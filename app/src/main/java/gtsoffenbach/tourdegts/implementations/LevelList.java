...
public class LevelList {
    ...
    private static Level[] levels = {
            ...
            new Level("Mathe im BG","Mathe im Beruflichen Gym.", "Vorstellung der Themen die in der Oberstufe unterrichtet werden. Mit unteranderem einem kleinen Kenntnis Test im Bereich Mathe und der Vorstellung von Geogebra.", "Raum A109", "Herr Jost, Frau Merkel",5, false),
